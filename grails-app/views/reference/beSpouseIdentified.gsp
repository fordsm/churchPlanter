...
<div class="dialog">
	...
	<div>
	    <div>
	    <p>
		 &nbsp;<g:message code="message.churchPlanter.spouse.reference.360.wouldYouLikeToBeIdentified1"/>
		 </br></br>
		&nbsp;<g:message code="message.churchPlanter.spouse.reference.360.wouldYouLikeToBeIdentified2" args="[churchPlanterName, organizationName]" />
		 </br></br>
		...
		*Years Known:${reference.yearsKnown}</br>
		...
		&nbsp;<g:message code="message.churchPlanter.spouse.reference.360.wouldYouLikeToBeIdentified3" args="[churchPlanterName]" /></br></br>
		
		*<g:message code="message.churchPlanter.spouse.reference.360.wouldYouLikeToBeIdentified4"/>
		*<g:message code="message.churchPlanter.spouse.reference.360.wouldYouLikeToBeIdentified5"/>
		</br></br>
		
		<g:message code="message.churchPlanter.spouse.reference.360.wouldYouLikeToBeIdentified6"/>
