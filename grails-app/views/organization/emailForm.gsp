                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: resourceURLInstance, field: 'url', 'errors')}"> 
                                   <g:textArea name="mailToList" value="${mailToList}" style="height:30px" />
                                </td>
                            </tr>
							<tr class="prop">
                                <td valign="top" class="name width15">
                              ...
                              <tr>
                                ...
                                <td valign="top" class="value ${hasErrors(bean: resourceURLInstance, field: 'displayText', 'errors')}">                           
                               		 <g:textArea id="messageBody" name="messageBody" value="${resourceURLInstance?.displayText}"/>
                               	</td>
                            </tr>
                            ...
                            <tr class="prop">
                            	...
                            	<a href="${createLink(controller:'organization', action:'summaryReport',params:[ChurchPlanterId: params.ChurchPlanterId,pdf:'true'], id:params.id)}">
                        	...
                        	<tr class="prop">
                             ...
                             <g:actionSubmit class="choose"  action="sendReportEmail" value="${message(code: 'default.button.send.label', default: 'Send')}" />
