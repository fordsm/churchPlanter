    ...
    <body>
		...
		<br />
		    ...
		    <table width="650" border="0" class="cpList">
                    ...
                    <g:each in="${userInstanceList}" var="churchPlanter" status="counter">
		 	 	...
		 	 	<div class="paginate">
		 	 	<g:paginate next="Next " prev="Previous" max="10"	controller="organization" params="[id:params?.id]" action="searchList" total="${userInstanceTotal}" /></div>
