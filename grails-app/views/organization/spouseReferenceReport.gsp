...
<html>
    ...
    <div id="pageBody">
		...
		${surveyResponse.survey.getTranslationByLocale()?.spouseSurveyReportOverview?:message(code:"message.churchPlanter.general.noTranslation") }
		...
		<tr>
			...
			<td style="overflow:hidden;height:12px;">
				<div>
					<img src="${resource(dir:'images',file:'purpleArrow.png',absolute:true)}" border="0" style="margin-left:${cpPercentageMap[category.id]?((450*(cpPercentageMap[category.id]/100)) - 6).setScale(0, BigDecimal.ROUND_HALF_UP):0}px;"/>
				</div>
			</td>
		</tr>
