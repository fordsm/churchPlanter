                        ...
                        <tbody>
                         	<tr class="prop" >
                                ...
                                <td valign="top" class="name">
                                  <b> ${userInstance?.email} <g:hiddenField name="id" value=" ${userInstance?.id}" />
                                  <g:hiddenField name="caller" value="${caller}" /></b>
                                </td>
                            </tr>
                             <tr class="prop">
                                <td valign="top" class="name width15">
                                    <label for="password"><g:message code="message.churchPlanter.registration.oldPassword" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'password', 'errors')}">                                    	                               
                                   	<g:passwordField name="oldpassword" value="${userInstance.hasErrors()?params.oldpassword:''}" />
                                </td>
                            </tr>
                            <tr class="prop">
                                <td valign="top" class="name width15">
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'password', 'errors')}">                                    
                                    <g:passwordField name="cpassword" value="${userInstance.hasErrors()?params.cpassword:''}" />
                                     <g:hiddenField name="changepassword" value="changepassword" />
